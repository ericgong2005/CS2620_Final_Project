...
MUSIC_DIR = "../Music"                # Path to your Music folder (relative to this script)
LOG_FILE = "chunk_upload_log.csv"     # CSV file to append results to
...
def run_chunked_upload_tests_all_files():
    ...
    appending to any existing data.
    """
